...
- Keep the FFmpeg runtime and Draw Text font exact, auditable, license-compatible, and pinned by `runtime.lock.json` / `font.lock.json`.
...
4. For runtime or font changes, review upstream release notes / snapshot provenance, update the appropriate lock file, rebuild, and verify hashes before committing.
