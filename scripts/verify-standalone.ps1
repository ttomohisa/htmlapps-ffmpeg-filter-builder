...
foreach ($marker in @('id="textFontLicense"', "TEXT_FONT_LICENSE_ASSET_KEY = 'license'", 'thirdPartyLicenses')) {
  if (-not $html.Contains($marker)) { throw "Embedded font license UI marker is missing: $marker" }
}
